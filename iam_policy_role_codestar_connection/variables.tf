variable "connection_arn" {
  type        = string
  description = "If provided, the policy will be specific to the connection, otherwise generic"
}

variable "connection_host_arn" {
  type        = string
  default     = null
  description = "If provided, the policy will include permissions for the host"
}
