...
locals {
  ...
  l1_map = {
    for k, v in local.l0_map : k => merge(v, module.name_map.data[k], {
      cache_accept_encoding_brotli = v.cache_accept_encoding_brotli == null ? var.policy_cache_accept_encoding_brotli_default : v.cache_accept_encoding_brotli
      cache_accept_encoding_gzip   = v.cache_accept_encoding_gzip == null ? var.policy_cache_accept_encoding_gzip_default : v.cache_accept_encoding_gzip
      ...
      ttl_default_second           = v.ttl_default_second == null ? var.policy_ttl_default_second_default : v.ttl_default_second
      ttl_max_second               = v.ttl_max_second == null ? var.policy_ttl_max_second_default : v.ttl_max_second
      ttl_min_second               = v.ttl_min_second == null ? var.policy_ttl_min_second_default : v.ttl_min_second
    })
  }
  l2_map = {
  ...
  output_data = {
    for k, v in local.lx_map : k => merge(
      ...
      {
        policy_id = aws_cloudfront_cache_policy.this_policy[k].id
      }
    )
  }
}
