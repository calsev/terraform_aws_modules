locals {
  output_data = {
    ...
    ecs_container_arn_long_format_enabled          = var.ecs_container_arn_long_format_enabled
    ecs_container_instance_arn_long_format_enabled = var.ecs_container_instance_arn_long_format_enabled
    ecs_container_insights_mode                    = var.ecs_container_insights_mode
    ...
    ecs_fargate_maintenance_window_delay_enabled   = var.ecs_fargate_maintenance_window_delay_enabled
    ecs_fargate_task_retirement_wait_period_days   = var.ecs_fargate_task_retirement_wait_period_days
    ecs_fargate_vcpu_quota_management_enabled      = var.ecs_fargate_vcpu_quota_management_enabled
    ecs_log_driver_non_blocking                    = var.ecs_log_driver_non_blocking
