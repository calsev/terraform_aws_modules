...
locals {
  ...
  l1_map = {
    for k, v in local.l0_map : k => merge(v, module.name_map.data[k], module.vpc_map.data[k], module.alarm_map.data[k], {
      ...
      instance_lifetime_max_hours                 = v.instance_lifetime_max_hours == null ? var.group_instance_lifetime_max_hours_default : v.instance_lifetime_max_hours
      ...
      instance_refresh_max_healthy_percentage     = v.instance_refresh_max_healthy_percentage == null ? var.group_instance_refresh_max_healthy_percentage_default : v.instance_refresh_max_healthy_percentage
      instance_refresh_min_healthy_percentage     = v.instance_refresh_min_healthy_percentage == null ? var.group_instance_refresh_min_healthy_percentage_default : v.instance_refresh_min_healthy_percentage
  ...
  l2_map = {
    for k, v in local.l0_map : k => {
      ...
      instance_refresh_protected_instance_enabled = v.instance_refresh_protected_instance_enabled == null ? var.group_instance_refresh_protected_instance_enabled_default == null ? !local.l1_map[k].auto_scaling_protect_from_scale_in : var.group_instance_refresh_protected_instance_enabled_default : v.instance_refresh_protected_instance_enabled
