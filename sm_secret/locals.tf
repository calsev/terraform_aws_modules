...
module "policy_map" {
  ...
  create_policy_default      = var.secret_create_policy_default
  name_map                   = var.secret_map
  policy_access_list_default = var.secret_policy_access_list_default
  policy_name_infix_default  = var.secret_policy_name_infix_default
  policy_name_prefix_default = var.secret_policy_name_prefix_default
  policy_name_suffix         = "secret"
  std_map                    = var.std_map
}
