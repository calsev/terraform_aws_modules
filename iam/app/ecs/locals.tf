locals {
  output_data = merge(module.managed_policies.data, {
    ...
    iam_policy_arn_ecs_exec_ssm      = module.ecs_exec_ssm_policy.iam_policy_arn
    iam_policy_arn_ecs_start_task    = module.ecs_start_task_policy.iam_policy_arn
    iam_policy_doc_ecs_exec_ssm      = jsondecode(data.aws_iam_policy_document.ecs_exec_ssm_policy.json)
