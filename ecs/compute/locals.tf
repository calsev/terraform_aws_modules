...
locals {
  ...
  l3_map = {
    for k, v in local.l0_map : k => {
      auto_scaling_protect_from_scale_in = v.auto_scaling_protect_from_scale_in == null ? var.compute_auto_scaling_protect_from_scale_in_default == null ? local.l2_map[k].provider_managed_termination_protection : var.compute_auto_scaling_protect_from_scale_in_default : v.auto_scaling_protect_from_scale_in
    }
  }
  lx_map = {
