          ...
          linuxParameters = {
            ...
            devices = [
              for k_dev, v_dev in v_def.linux_device_map : {
                hostPath      = k_dev
                containerPath = v_def.container_path
                permissions   = v_def.permission_list == null ? var.task_container_linux_device_permission_list_default : v_def.permission_list
              }
            ]
