...
locals {
  ...
  l1_map = {
    for k, v in local.l0_map : k => merge(v, module.name_map.data[k], module.vpc_map.data[k], {
      ...
      log_level_application               = v.log_level_application == null ? var.function_log_level_application_default : v.log_level_application
      log_level_system                    = v.log_level_system == null ? var.function_log_level_system_default : v.log_level_system
