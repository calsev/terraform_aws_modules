    ...
    for k_pool, v_pool in var.pool_map : [
      for k_app, v_app in v_pool.client_app_map : merge(
        ...
        v_app,
        {
          ...
          refresh_token_rotation_enabled                    = v_app.refresh_token_rotation_enabled == null ? var.client_refresh_token_rotation_enabled_default : v_app.refresh_token_rotation_enabled
          refresh_token_rotation_retry_grace_period_seconds = v_app.refresh_token_rotation_retry_grace_period_seconds == null ? var.client_refresh_token_rotation_retry_grace_period_seconds_default : v_app.refresh_token_rotation_retry_grace_period_seconds
          ...
          user_pool_id                                      = v_pool.user_pool_id == null ? var.pool_user_pool_id_default : v_pool.user_pool_id
